...
func init() {
	...
	proto.RegisterMapType((map[string]uint32)(nil), "configuration.Reply.PortEntry")
}
...
func (*UnimplementedConfiguratorServer) ConfigurationRequest(req *Request, srv Configurator_ConfigurationRequestServer) error {
