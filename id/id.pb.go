...
/*
Package __id is a generated protocol buffer package.
...
func (*IDFull) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }

func (m *IDFull) GetRequest() *google_protobuf.Empty {
	if m != nil {
		return m.Request
	}
	return nil
...
func (*IDNode) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
type Reply struct {
	ReturnCode  ReturnCode `protobuf:"varint,1,opt,name=return_code,json=returnCode,enum=id.ReturnCode" json:"return_code,omitempty"`
...
func (c *iDClient) IDFullRequest(ctx context.Context, in *IDFull, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := grpc.Invoke(ctx, "/id.ID/IDFullRequest", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iDClient) IDNodeRequest(ctx context.Context, in *IDNode, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := grpc.Invoke(ctx, "/id.ID/IDNodeRequest", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
