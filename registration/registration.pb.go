...
func (*UnimplementedRegisterServer) RegistrationRequest(ctx context.Context, req *Registration) (*Reply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegistrationRequest not implemented")
}
func (*UnimplementedRegisterServer) MonitorSession(srv Register_MonitorSessionServer) error {
